            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Supplier store name -->
                        <div class="mb-3">
                            <label class="small mb-1" for="shopname">Store Name<span class="text-danger">*</span></label>
                            <input class="form-control form-control-solid @error('store_name') is-invalid @enderror" id="store_name" name="store_name" type="text" placeholder="" value="{{ old('shopstore_namename', $supplier->store_name) }}" />
                            @error('store_name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
